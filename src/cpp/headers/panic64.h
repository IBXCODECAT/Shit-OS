...
void PANIC()
{
	...
	PrintString("A problem has occured and ndOS has entered a krnl panic to prevent possible\n\rdamage to your device's hardware or software.\n\n\r");
	...
	PrintString("Verify that any new hardware or software is properly installed. If this is a new\rinstalation, ask the developers of ndOS for any upates you might need. If\n\rproblems persist you can file a bug report on our website, or lookup the\n\rerror code bellow in our GitHub documentation.\n\n\r");
	...
	PrintString("Contact the developers of ndOS for further assistance\n\n\r");
